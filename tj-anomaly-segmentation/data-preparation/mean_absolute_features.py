#这个文档从dissimilarity中加载一个测试用的dataloader的配置，然后用torch上直接pretrain好的vgg模型来构造
#输入和生成图片的mean_absolute特征的差异
...
if __name__ == '__main__':
    ...
    gpu_ids = '6' #to do
    dataroot = '/home/giancarlo/data/innosuisse/custom_both' # to do
    data_origin = 'spade' # to do
