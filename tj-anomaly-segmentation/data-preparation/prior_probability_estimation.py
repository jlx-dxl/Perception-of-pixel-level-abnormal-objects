#this file is used to come up with the softmax result and the semantic result
...
# the output of the net isn't be softmaxed
...
for img_id, img_name in enumerate(images):
    ...
    img_tensor = img_transform(img) # don't forget the normalization
