...
parser.add_argument('--nw_mult', type=int, default=1,
                    help='the num of working process per gpu to send the data to RAM to load')
...
def train(train_loader, net, optim, curr_epoch, writer):
    ...
    for i, data in enumerate(train_loader):
        ...
        inputs, gts = inputs.cuda(), gts.cuda() #to verify
