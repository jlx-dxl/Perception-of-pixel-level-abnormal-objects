...
# Use class weighted loss per batch to increase loss for low pixel count classes per322 batch
...
__C.DATASET.MAPILLARY_DIR = '/media/group1/data/pengjianyi/mapillary_vistas_dataset_public_v1_2'
